    ...
    <md-table md-sort="name" md-sort-order="asc" md-card>
        <md-table-toolbar>
            <div class="md-toolbar-section-start">
                <h1 class="md-title">Rate ranges
                    <md-menu md-direction="top-start" :md-active.sync="rangeInfo">
                        <md-icon md-menu-trigger class="md-primary info">info</md-icon>
                        <md-menu-content>
                            <p style="padding:0 20px !important;">6 range points is the limit,<br> if you add more that will be<br> considered above 10k. <br>
                                <md-divider></md-divider>
                                !Please make sure to enter/update <br> values sorted ascending order.
                            </p>
                        </md-menu-content>
                    </md-menu>
                </h1>
        ...
        <md-table-empty-state md-label="No state found" :md-description="`No state found for this query. Try a different search term or create a new state.`">
            <md-button class="md-primary md-raised" @click="add()">Create new range</md-button>
