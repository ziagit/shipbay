...
<div class="rates" v-if="rates">
    ...
    <md-table md-sort="name" md-sort-order="asc" md-card>
        ...
        <md-table-empty-state md-label="No state found" :md-description="`No state found for this query. Try a different search term or create a new state.`"></md-table-empty-state>
        <div class="table-content">
            ...
            <md-table-row v-for="rate in rates.data" :key="rate.id">
                ...
                <md-table-cell v-if="rate.carriers[0].company">{{ rate.carriers[0].company }}</md-table-cell>
