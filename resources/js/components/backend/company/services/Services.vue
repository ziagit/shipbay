<template>
  <div class="main-container">
    ...
    <md-dialog :md-active.sync="editTogal">
      <md-dialog-title>Update service data</md-dialog-title>
      <md-dialog-content>
        <EditService v-on:close-dialog="refresh" :service="service" />
      </md-dialog-content>
    </md-dialog>
    <!-- add dialog -->
    <md-dialog :md-active.sync="addTogal">
      <md-dialog-title>Add new service</md-dialog-title>
      <md-dialog-content>
        <AddService v-on:close-dialog="refresh" />
      </md-dialog-content>
    </md-dialog>
    ...
    <md-table md-sort="name" md-sort-order="asc" md-card>
      ...
      >
        <md-button class="md-primary md-raised" @click="add()">Create new service</md-button>
      </md-table-empty-state>
      <md-table-row>
...
export default {
  ...
  methods: {
    search() {
      axios
        .get("admin/search-service", { params: { keywords: this.keywords } })
        .then((res) => {
    ...
    confirm() {
      axios
        .delete("admin/services/" + this.selectedId)
        .then((res) => {
