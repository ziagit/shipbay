<template>
<div class="container">
    <div class="section0" v-bind:style="{ 'background-image': 'url(/images/uploads/help.svg)' }">
        ...
        <div class="wrapper">
            <div class="left">
                ...
                <md-steppers md-vertical :md-active-step.sync="active">
                    <md-step id="first" md-label="I want to set up an account." md-description="Click to read more">
                        <div class="md-body-1">
                            Call us at 800.323.5441 or
                            <router-link to="/register">set up your account online</router-link>.
                        </div>
                    </md-step>
                    <md-step id="second" md-label="What if I need help after regular business hours?" md-description="Click to read more">
                        <div class="md-body-1">
                    ...
                    <md-step id="third" md-label="I’m a carrier wanting to become a ShippingTAP contract carrier." md-description="Click to read more">
                        <div class="md-body-1">
                    ...
                    <md-step id="fifth" md-label="My shipment was late and I paid for guaranteed service." md-description="Click to read more">
                        <div class="md-body-1">
                            Contact ShippingTAP customer service, 800.323.5441, to file a
                            claim with the contract carrier.
                        </div>
                    </md-step>
                    <md-step id="sixth" md-label="Can customer service reps book freight on the phone?" md-description="Click to read more">
                        <div class="md-body-1">
                    ...
                    <md-step id="seventh" md-label="I need to know how to pack my items, do you have any advice?" md-description="Click to read more">
                        <div class="md-body-1">
                    ...
                    <md-step id="eighth" md-label="I want to change or cancel my pick up date." md-description="Click to read more">
                        <div class="md-body-1">
                            Sign into your ShippingTAP account to cancel or rebook. You can
                            also call to change or cancel the pickup date.
                        </div>
                    </md-step>
                    <md-step id="nineth" md-label="Calling Customer service, we can often solve issues faster if you provide:" md-description="Click to read more">
                        <div class="md-body-1">
                            <ul>
