...
<div class="item">
    ...
    <md-card mode="ios" color="light" v-if="items.length > 0">
        <md-card-content>
            <div v-show="itemExistError" style="color:red">The item you are adding already exist here, please remove it first.</div>
            <ul>
        ...
        <div class="items">
            ...
            <md-field>
                <md-select v-model="item.type" name="type" id="type" placeholder="Package type">
                    <md-option v-for="i in itemTypes" :key="i.id" :value="i.id" :typeName="i.title">{{i.title}}</md-option>
                </md-select>
