...
<div class="delivery-services">
    ...
    <form @submit.prevent="nextStep()">
        <div class="options">
            <md-checkbox v-for="service in accessories" :key="service.id" v-model="services" :value="service.code" @change="checkboxToggle(service)">{{service.name}}</md-checkbox>
        ...
        <div class="action">
            ...
            <md-button class="md-icon-button md-raised md-primary my-color" type="submit">
